...
namespace Group2_CompRepair.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(JwtAuthenticationManager jwtAuthenticationManager, Group2_ComprepairContext context)
        {
        ...
        /*public EmployeesController(Group2_ComprepairContext context)
        {
            _context = context;
        }*/
